...
SUBSET_NAMES = {
    ...
    'imagenet_100': ["robin", "Gila monster", "hognose snake", "garter snake", "green mamba",
    ...
    'pets': ['Abyssinian', 'American Bulldog', 'American Pit Bull Terrier', 'Basset Hound', 'Beagle',
    ...
    'food101': ['apple_pie', 'baby_back_ribs', 'baklava', 'beef_carpaccio', 'beef_tartare',
                ...
                'waffles'],
    'fgvc_aircraft': ['707-320', '727-200', '737-200', '737-300', '737-400',
    ...
    'dtd': ['banded', 'blotchy', 'braided', 'bubbly', 'bumpy',
            ...
            'wrinkled', 'zigzagged'],
    'flowers102': ['pink primrose', 'hard-leaved pocket orchid', 'canterbury bells', 'sweet pea', 'english marigold',
    ...
    'sun397': ['abbey', 'airplane_cabin', 'airport_terminal', 'alley', 'amphitheater',
    ...
    'caltech101': ['face', 'leopard', 'motorbike', 'accordion', 'airplane',
